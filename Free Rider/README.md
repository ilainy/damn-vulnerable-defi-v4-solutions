...
结合**合约逻辑漏洞 + Uniswap V2 闪电贷**。项目方上线了 NFT 交易市场，铸造了 6 枚 NFT，单枚售价 15 ETH，同时部署回收合约，只要集齐全部 6 枚 NFT 转入回收合约，即可领取 **45 ETH 官方赏金**。
...
Free Rider 由**批量购买计价逻辑错误**漏洞主导，搭配 Uniswap V2 闪电贷完成零成本套利。开发者忽视了`msg.value` 在单次交易中全局不变的特性，导致批量低价购买资产。结合币种转换、闪电贷回调、NFT 接收接口等知识点，考 DeFi 合约审计攻击能力。
